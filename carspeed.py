...
def get_speed(pixels, ftperpixel, secs):
    if secs > 0.0:
        ...
        #return (((pixels * ftperpixel)/ secs) * 0.681818) * 1.609344  
        #me and my homies only uses km
...
DISTANCE = 1  #<---- enter your distance-to-road value here
    ...
    if motion_found:
        if state == WAITING:
            ...
            if state == TRACKING:       
                ...
                print(format(mph, ".2f"), "km/h")
                mylcd.lcd_display_string(format(mph, ".2f") + " km/h   ")
